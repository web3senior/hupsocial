...
import { base, baseSepoliaPreconf, celoSepolia, opBNBTestnet, arbitrumSepolia, lineaGoerli, monadTestnet, somniaTestnet, mainnet, optimism, lukso, luksoTestnet } from 'wagmi/chains'
...
export const CONTRACTS = {
  ...
  chain11142220: {
    post: '0xeD440Ee83A20FAc55B8C16dd59e52A2CEE1D272B',
    comment: '0xd5872D7dD918b3fD60e6EE70B9E521386140360f',
...
celoSepolia.primaryColor = `#F2F423`
...
lineaGoerli.icon = `<svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg"> <g clip-path="url(#clip0_10733_2645)"> <path d="M0 0H18V18H0V0Z" fill="#190066"/> <path d="M6.4 11.67H12V13H5V6H6.4V11.67ZM11.75 4.5C12.0815 4.5 12.3995 4.6317 12.6339 4.86612C12.8683 5.10054 13 5.41848 13 5.75C13 6.08152 12.8683 6.39946 12.6339 6.63388C12.3995 6.8683 12.0815 7 11.75 7C11.4185 7 11.1005 6.8683 10.8661 6.63388C10.6317 6.39946 10.5 6.08152 10.5 5.75C10.5 5.41848 10.6317 5.10054 10.8661 4.86612C11.1005 4.6317 11.4185 4.5 11.75 4.5Z" fill="#61DFFF"/> </g> <defs> <clipPath id="clip0_10733_2645"> <rect width="18" height="18" fill="white"/> </clipPath> </defs> </svg>`
...
export const config = createConfig({
  chains: [luksoTestnet, arbitrumSepolia, celoSepolia, monadTestnet, baseSepoliaPreconf, lineaGoerli, somniaTestnet, opBNBTestnet],
