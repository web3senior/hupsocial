...
import { base, baseGoerli, lineaGoerli, arbitrumGoerli, somniaTestnet, mainnet, optimism, lukso, luksoTestnet } from 'wagmi/chains'
...
export const config = createConfig({
  chains: [luksoTestnet, arbitrumGoerli, baseGoerli, lineaGoerli, somniaTestnet], //mainnet, base, lukso,
