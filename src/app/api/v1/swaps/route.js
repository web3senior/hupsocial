 ...
 *     venue VARCHAR(8) NOT NULL DEFAULT 'v3',      -- 'v3' | 'v4' | 'sushi' | 'launch'; widened from VARCHAR(4) 2026-08-16
...
export async function POST(request) {
  try {
    ...
    const venue = ['v3', 'v4', 'sushi', 'launch'].includes(body.venue) ? body.venue : 'v3'
