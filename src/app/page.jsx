...
export default function Page() {
  ...
  useEffect(() => {
    ...
    //     console.log(res)
    //     if (Array.isArray(res)) setPolls(res)
    //   })
    // })
  ...
  <WalletOptions/>
    ...
    //             <img className={`animate__animated animate__heartBeat`} src={`/emoji/${selectedEmoji.item.emoji}.svg`} alt={`${process.env.NEXT_PUBLIC_NAME}`} width={64} height={64} title={selectedEmoji.item.name} />
    //           </figure>
    //           <div className={`flex flex-row align-items-center justify-content-center gap-025 mt-10`}>
    //             <span className={`${styles.price} rounded`}>{web3.utils.fromWei(selectedEmoji.item.price, `ether`)}</span>

    //             <div className={`${styles.priceIcon} flex align-items-center rounded`}>
    ...
    //         </div>
    //         <div className={`flex flex-row gap-025 mt-10`}>
    //           <button type="submit" ref={giftModalSendButton} onClick={() => giftModalClose(`send`)}>
    //             Send
    //           </button>
    //           <button id="cancel" type="reset" ref={giftModalCancelButton} onClick={() => giftModalClose(`cancel`)}>
    //             Cancel
    //           </button>
    //         </div>
    //       </form>
    ...
    //                       <small className={`lable lable-primary text-uppercase`}>Only Holders</small>
    ...
    //                   <section className={`${styles.poll__actions} w-100 flex flex-row align-items-center justify-content-start`}>
    //                     <button>
    ...
    //                         />
    //                       </svg>
    //                       <span>{new Intl.NumberFormat().format(7.48)} STT</span>
    //                     </button>
