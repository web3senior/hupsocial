  ...
  return (
    <div className={`${styles.page} ms-motion-slideDownIn`}>
      ...
      <div className={`__container ${styles.page__container} flex flex-column align-items-start justify-content-start`} data-width={`medium`} style={{ padding: `1rem` }}>
        ...
        <p>
          Hup is a fully on-chain social protocol where <strong>most of your activity is public and visible on the blockchain</strong>. However, the actual content of your posts is stored on IPFS, which means you&#39;ll
          eventually be able to delete it.
        </p>
