...
library PostEvent {
    ...
    event PostCreated(uint256 indexed postId, address indexed creator, string metadata, string content);
    ...
    // --- Interaction Events ---
    event PostLiked(uint256 indexed postId, address indexed liker, address indexed creator);
    event PostUnliked(uint256 indexed postId, address indexed unliker, address indexed creator);
