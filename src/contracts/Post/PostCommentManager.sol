...
contract PostCommentManager is Ownable(msg.sender), ReentrancyGuard {
    ...
    function getCommentsByPostId(uint256 _postId, uint256 _startIndex, uint256 _count) 
        external 
        view 
    ...
    function getRepliesByCommentId(uint256 _parentId, uint256 _startIndex, uint256 _count) 
        external 
        view 
